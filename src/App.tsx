...
export default function App() {
  return (
    <>
      {/* The bundle's intro. An overlay OVER the routes below, never a gate
          in front of them: the app mounts and renders underneath on the
          first frame, so nothing here delays reaching a note, and it is
          dismissible on any tap or key. It refuses /toast and /clip-panel
          outright (see lib/introGate) — those two windows are the Alt+N
          capture toast and the Alt+M paste panel, and their entire value is
          opening instantly. */}
      <IntroAnimation />
      <Routes>
